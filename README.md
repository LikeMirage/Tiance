...
详细原理见：[Markdown 转 Word：从 LaTeX 到原生可编辑公式](docs/02_Markdown转Word工具设计.md)。
...
详细设计见：[后端供应商能力桥与内置网络搜索](docs/10_后端供应商能力桥与内置网络搜索.md)。
...
详细设计见：[前端能力桥与会话管理工具](docs/09_前端能力桥与会话管理工具.md)。
